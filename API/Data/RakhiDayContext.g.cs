...
using RakhiDay.Entities;

namespace RakhiDay.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class RakhiDayContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=codezen.database.windows.net;Initial Catalog=T976123_RakhiDay;Persist Security Info=True;user id=Lowcodeadmin;password=NtLowCode^123*;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
