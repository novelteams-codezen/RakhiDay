...
using System.Text;
using RakhiDay.Models;
using RakhiDay.Services;
using RakhiDay.Logger;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "RakhiDay", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<RakhiDayContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "RakhiDay API v1");
